...
public class MetadataController {
    ...
    List<SimpleFieldMetadata> fetchFilters() {
        return asList(
                ...
                new SimpleFieldMetadata(INCOMING_REQUEST_TABLE, SIZE, SIZE.reference(), "Size", "count"),
                ...
                new SimpleFieldMetadata(INCOMING_REQUEST_TABLE, ACTION, ACTION.reference(), "Endpoints", "count"),
                new SimpleFieldMetadata(INCOMING_REQUEST_TABLE, RESOURCE, RESOURCE.reference(), "Ressource", "count"),
                new SimpleFieldMetadata(INCOMING_REQUEST_TABLE, CLIENT, CLIENT.reference(), "Client", "count"),
                new SimpleFieldMetadata(INCOMING_REQUEST_TABLE, GROUPE, GROUPE.reference(), "Groupe", "count"),
