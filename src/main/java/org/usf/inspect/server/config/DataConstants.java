...
import static org.usf.inspect.server.config.DbFields.CD_DTB_RQT;
import static org.usf.inspect.server.config.DbFields.CD_FTP_RQT;
import static org.usf.inspect.server.config.DbFields.CD_INS;
import static org.usf.inspect.server.config.DbFields.CD_PRN_SES;
import static org.usf.inspect.server.config.DbFields.CD_PRT;
import static org.usf.inspect.server.config.DbFields.CD_RMT_SES;
import static org.usf.inspect.server.config.DbFields.CD_STT;
import static org.usf.inspect.server.config.DbFields.DH_END;
import static org.usf.inspect.server.config.DbFields.DH_STR;
import static org.usf.inspect.server.config.DbFields.ID_DTB_RQT;
import static org.usf.inspect.server.config.DbFields.ID_FTP_RQT;
import static org.usf.inspect.server.config.DbFields.ID_INS;
import static org.usf.inspect.server.config.DbFields.ID_SES;
import static org.usf.inspect.server.config.DbFields.VA_ADR;
import static org.usf.inspect.server.config.DbFields.VA_APP;
import static org.usf.inspect.server.config.DbFields.VA_ARG;
import static org.usf.inspect.server.config.DbFields.VA_ATH_SCH;
import static org.usf.inspect.server.config.DbFields.VA_CCH_CTR;
import static org.usf.inspect.server.config.DbFields.VA_CLR;
import static org.usf.inspect.server.config.DbFields.VA_CLT_VRS;
import static org.usf.inspect.server.config.DbFields.VA_CMD;
import static org.usf.inspect.server.config.DbFields.VA_CNT;
import static org.usf.inspect.server.config.DbFields.VA_CNT_TYP;
import static org.usf.inspect.server.config.DbFields.VA_CPT;
import static org.usf.inspect.server.config.DbFields.VA_DRV;
import static org.usf.inspect.server.config.DbFields.VA_ENV;
import static org.usf.inspect.server.config.DbFields.VA_ERR_MSG;
import static org.usf.inspect.server.config.DbFields.VA_ERR_TYP;
import static org.usf.inspect.server.config.DbFields.VA_HST;
import static org.usf.inspect.server.config.DbFields.VA_I_CNT_ENC;
import static org.usf.inspect.server.config.DbFields.VA_I_SZE;
import static org.usf.inspect.server.config.DbFields.VA_LCT;
import static org.usf.inspect.server.config.DbFields.VA_MSK;
import static org.usf.inspect.server.config.DbFields.VA_MTH;
import static org.usf.inspect.server.config.DbFields.VA_NAM;
import static org.usf.inspect.server.config.DbFields.VA_OS;
import static org.usf.inspect.server.config.DbFields.VA_O_CNT_ENC;
import static org.usf.inspect.server.config.DbFields.VA_O_SZE;
import static org.usf.inspect.server.config.DbFields.VA_PCL;
import static org.usf.inspect.server.config.DbFields.VA_PRD_NAM;
import static org.usf.inspect.server.config.DbFields.VA_PRD_VRS;
import static org.usf.inspect.server.config.DbFields.VA_PTH;
import static org.usf.inspect.server.config.DbFields.VA_QRY;
import static org.usf.inspect.server.config.DbFields.VA_RE;
import static org.usf.inspect.server.config.DbFields.VA_SRV_VRS;
import static org.usf.inspect.server.config.DbFields.VA_THR;
import static org.usf.inspect.server.config.DbFields.VA_TYP;
import static org.usf.inspect.server.config.DbFields.VA_USR;
import static org.usf.inspect.server.config.DbFields.VA_USR_AGT;
import static org.usf.inspect.server.config.DbFields.VA_VRS;
