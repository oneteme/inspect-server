...
import org.usf.inspect.server.service.lazy.RequestService;
import org.usf.inspect.server.service.lazy.SessionQueueService;
...
import static org.usf.inspect.server.controller.lazy.RetroUtils.*;
...
public class TraceController {
    ...
    public ResponseEntity<Void> addSessions( @PathVariable("id") String id,
    	...
    	try {
            ...
            toV4(id, sessions, queueService::addMetrics);
