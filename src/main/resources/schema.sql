...
CREATE TABLE IF NOT EXISTS E_RST_RQT ( --E_RST_RQT
	...
	VA_ERR_TYP VARCHAR, --VA_ERR_TYP
	VA_ERR_MSG VARCHAR, 
	CD_PRN_SES VARCHAR, -- Parent
	CD_RMT_SES VARCHAR -- NUll  --CD_RMT_SES : remote session
);
...
-- exception => cd_req, cd_act, type, mesg, type_req
